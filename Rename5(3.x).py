...
Name = input("Input the form of the name\nFor example:\nElementary.S%sE%s.720p.WEB-DL.DD5.1.H.264-ECI.DivX\n")
Season = input("Please input the Season you are editing\n")
Type = input("Please input the Type of the Files\n")
